(function() {
  ...
  function App() {
    const [tableHtml, setTableHtml] = d();
    y(() => {
      chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
        if (message.action === "parseHTML") {
          ...
          console.info("message-back", message);
    ...
    console.info("tableHtml", tableHtml);
    return /* @__PURE__ */ u$1(k$1, { children: [
      /* @__PURE__ */ u$1("header", { children: /* @__PURE__ */ u$1("h2", { style: { marginTop: 0 }, children: "IBIS+" }) }),
      /* @__PURE__ */ u$1("main", { style: { display: "grid", gridTemplateColumns: "1fr 1fr" }, children: [
        /* @__PURE__ */ u$1("section", { style: { border: "1px solid red" }, children: [
          /* @__PURE__ */ u$1(
            "button",
            {
              onClick: () => {
          ...
          !!tableHtml && /* @__PURE__ */ u$1("div", { dangerouslySetInnerHTML: { __html: tableHtml } })
        ] }),
        /* @__PURE__ */ u$1("aside", { style: { border: "1px solid blue" } })
      ] })
    ] });
  }
